  ...
  <div class="orders">
    ...
    <div v-else>
      ...
      <div class="card">
        ...
        <p v-if="restockOrders.length === 0" class="empty-message">{{ t('orders.noSubmittedOrders') }}</p>
  ...
  setup() {
    ...
    const loadOrders = async () => {
      try {
        ...
        // Restock orders are not affected by the global filters - the API already returns them newest-first
